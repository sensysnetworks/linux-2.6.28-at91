...
/* 
 * FIXME: with DEBUG_VM turned on, a BUG is caught in this driver from the
 * at91_mci_irq() handler through flush_dcache_page(). NULL pointer
 * dereference in include/linux/mm.h:635
 */
