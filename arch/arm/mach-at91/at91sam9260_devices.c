...
void __init at91_add_device_i2c(struct i2c_board_info *devices, int nr_devices)
{
	...
	at91_set_multi_drive(SDA_PIN, 1);

	at91_set_GPIO_periph(SCL_PIN, 1);		/* TWCK (SCL) */
	at91_set_multi_drive(SCL_PIN, 1);
...
static const unsigned spi0_standard_cs[2] = { AT91_PIN_PA3, AT91_PIN_PC11 };
#elif defined (CONFIG_RIMS_MCB)
static const unsigned spi0_standard_cs[8] = { 
	AT91_PIN_PA3, AT91_PIN_PC11, AT91_PIN_PB0, AT91_PIN_PB1, 
	AT91_PIN_PB2, AT91_PIN_PB3, AT91_PIN_PB4, AT91_PIN_PB5 
};
#else
...
static const unsigned spi1_standard_cs[4] = { RDAC_PIN_SPI1CS0, RDAC_PIN_SPI1CS1, 
	RDAC_PIN_SPI1CS2, RDAC_PIN_SPI1CS3 };
#else
...
#elif defined(CONFIG_SOM9G20_WATCHDOG) || defined(CONFIG_SOM9G20_WATCHDOG_MODULE)
static struct platform_device at91sam9260_wdt_device = {
	.name		= "som9g20_wdt",
	.id		= -1,
	.num_resources	= 0,
